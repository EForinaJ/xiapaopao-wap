            ...
            <u-skeleton :loading="loading" rows="4">
                <view class="list" v-if="!loading" >
                    ...
                    v-for="(item, index) in list" :key="index">
                            ...
                            <u-row >
                                <u-col span="6">
                                    <view class="orderType">
                                        佣金：{{base.currencySymbol}}{{item.commission}}
                                    </view>
                                </u-col>
                                <u-col span="6">
                                    <view class="orderStatus">
                                        服务费：{{base.currencySymbol}}{{item.serviceMoney}}
                                    </view>
                                </u-col>
                            </u-row>
                        </view>
                        ...
                        <view class="orderType" v-if="item.isPayment  == 1">
                            状态：未打款
                        </view>
                        <view class="orderType" v-if="item.isPayment  == 2">
                            状态：已打款到余额
                        </view>
...
export default {
    ...
    methods:{
        ...
        async getList(){
			try {
                this.status = "loading"
                const res = await uni.$u.http.get(api.getCommissionList,{
