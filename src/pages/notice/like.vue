                ...
                <view class="item" v-for="(item,index) in list" :key="index">
                    ...
                    <view class="info">
                        <view class="nickName-date">
                            ...
                            <view class="date">
                                <u--text  v-if="item.module == 'post'"  size="24rpx" type="info" text="点赞了我的内容"></u--text>
                                <u--text v-if="item.module == 'comment'"  size="24rpx" type="info" text="赞了我的评论"></u--text>
                            </view>
                        </view>
                        <view>
                            <view class="date">
                                <u--text size="24rpx" type="info" :text="item.createTime | resetDate"></u--text>
                            </view>
                        </view>
                    </view>
                    <view class="detail">
                        <u--text v-if="item.module == 'post'"  @click="goPost(item.detail.id)" :lines="3" size="24rpx"  :text="item.detail !=null ? item.detail.title : ''"></u--text>
                        <u--text v-if="item.module == 'comment'"  @click="goPost(item.detail.detail.id)" :lines="3" size="24rpx"  :text="item.detail.detail !=null ? item.detail.content : ''"></u--text>
                    </view>
                </view>
                <view class="more">
