	...
	<view class="content">
        ...
        <view class="u-page" v-if="!loading">
            <view class="cover-info">
                <view class="cover">
                    <u--image radius="8rpx" width="200rpx" height="200rpx"  :src="info.cover">
                    </u--image>
                </view>
                <view class="info">
                    <view class="title">
                    ...
                    <view class="description">
                        <u--text size="24rpx" type="info" :lines="4" :text="info.description"></u--text>
                    </view>
                </view>
            </view>
		...
		@close="closeShareSheet">
			...
			<view class="share-action">
				<view class="share-list">
					...
					<!-- #ifdef H5 -->
					<view class="item" v-clipboard:copy="`${base.url}/wiki/${info.id}`" 
...
export default {
	...
	methods: {
        async getData(){
            const res = await uni.$u.http.get(api.getWikiInfo,{
				params:{id: this.id},
				custom: {auth: false},
			})
			if (res.code != 1) {
        ...
        openPaySheet(){
            ...
            this.pay.form.detailModule = "wiki"
